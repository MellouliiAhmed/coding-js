...
// Marketing thinks it would be great to welcome visitors to the site in their own language. Luckily you already use an API that detects the users location,
...
// checks if the object "languages" contains a property named by the value of the variable "language".